/* Take a number 'num' as input. Print the series of all even numbers and all odd numbers from 
   ...
   Also calculate and print the sum of all even numbers and the sum of all odd numbers.(Using while loop)
   Example: num = 7
...
int main()
{
    int i=1,num=0,even_sum=0,odd_sum=0;
    ...
    while(i<=num)
    {
        ...
        i++; // increasing the value of i till the given number
    }
    cout << "\n" << "The odd series is : ";
    i=1; // again initializing i value so it can be used again
    while(i<=num)
    {
        if(i%2!=0)
        {
